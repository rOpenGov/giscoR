...
ggsave("vignettes/country.png", width = 4*0.75, height = 3*0.75)
...
ggsave("vignettes/africa.png", width = 4*0.75, height = 4*0.75)
...
ggsave("vignettes/choro.png", width = 4, height = 4)
