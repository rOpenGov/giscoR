...
#> Error in gsc_api_cache(api_entry, filename, cache_dir, update_cache, verbose): Download failed
...
#> Error in eval(expr, envir, enclos): object 'nuts2' not found

# Cut
nuts2.sf$values_groups <- cut(nuts2.sf$values, breaks = br)
#> Error in eval(expr, envir, enclos): object 'nuts2.sf' not found
