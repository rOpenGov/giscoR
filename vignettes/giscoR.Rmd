...
countries <- gisco_get_countries(resolution = "20", region = "Asia")
...
```{r benelux, fig.width=7, fig.asp=1}
...
benelux_10 <- gisco_get_countries(resolution = "10", country = c("BEL","NLD","LUX"))
benelux_03 <- gisco_get_countries(resolution = "03", country = c("Belgium","Holanda","Luxembourg"))

opar <- par(no.readonly = TRUE)
par(mfrow = c(2, 2))
plot(st_geometry(benelux_60), main = "60M")
plot(st_geometry(benelux_20), main = "20M")
plot(st_geometry(benelux_10), main = "10M")
plot(st_geometry(benelux_03), main = "03M")
title(sub = gisco_attributions(copyright = "FALSE"), cex.sub = 0.7)
par(opar)
...
```{r giscoR_eurostat, fig.width=6.5,fig.asp=1, message=FALSE, warning=FALSE}
library(eurostat)
library(cartography)
library(colorspace)
...
# Basemap
basemap <- gisco_get_coastallines(resolution = "10",
                                  year = "2016",
                                  epsg = "3035")
