...
This is an example on how `giscoR` can play nicely with `eurostat`. For plotting purposes we would use the [`cartography` package](https://riatelab.github.io/cartography/docs/index.html), however any package that handles `sf` objects (e.g. `ggplot2`, `tmap`, `leaflet`, etc. could be used). 
