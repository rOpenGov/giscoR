...
<div class="figure">
<img src="./country-1.png" alt="Political map of Asia" width="100%" />
<p class="caption">Political map of Asia</p>
</div>
...
that handles `sf` objects (e.g. `tmap`, `mapsf`, `leaflet`, etc. could be used).
...
<div class="figure">
<img src="./giscoR-1.png" alt="Disposable income of private households by NUTS 2 regions (2016)" width="100%" />
<p class="caption">Disposable income of private households by NUTS 2 regions (2016)</p>
</div>
