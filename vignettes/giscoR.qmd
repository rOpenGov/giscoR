...
provide a simple interface to Eurostat's [GISCO geodata
...
especially on Europe but also offering global datasets such as country
...
we use **ggplot2**. Any package that supports **sf** objects, such as **tmap**,
**mapsf** or **leaflet**, can be used.
