...
are available in three projections: [EPSG:4326](https://epsg.io/4326),
...
plotting, we use **ggplot2**. Any package that supports `sf` objects (e.g.,
**tmap**, **mapsf**, **leaflet**) can be used.
