...
```{r}
#| label: fig-country
#| fig-cap: EU Member states and Candidate countries (2024)
library(dplyr)
library(ggplot2)
...
```{r}
#| label: fig-africa
#| fig-cap: Political map of North Africa
...
```{r}
#| label: fig-giscor
#| fig-cap: Disposable income of private households by NUTS 2 regions (2022)
#| fig-dpi: 200
# EU members
library(giscoR)
library(dplyr)
