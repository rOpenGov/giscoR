...
subnational regions. It supplies shapefiles in different formats, focusing
...
areas (01M, 03M), and lighter datasets for larger areas (10M, 20M, 60M).
...
subsequent requests for the same data can be served from the local cache.

If downloading fails, you can manually download the file from the [GISCO API
website](https://gisco-services.ec.europa.eu/distribution/v2/) and place it in
