...
subnational regions. It supplies geospatial files in different formats, focusing
...
Review the following attribution and licensing requirements when using GISCO
data:
...
acceptance of these rules. See the [administrative
...
The `gisco_attributions()` function provides guidance on this topic and returns
attributions in several languages.
...
The following example downloads EU member states and candidate countries as of
2024.
