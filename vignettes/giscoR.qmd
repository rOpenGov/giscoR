...
Within Eurostat, GISCO supports geographic data at three levels: the European
Union, its member countries, and its regions. GISCO provides shapefiles in
different formats, focusing especially on the European Union but also offering
worldwide datasets such as country polygons, labels, borders, and coastlines.
