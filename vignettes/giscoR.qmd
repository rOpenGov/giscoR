...
GISCO provides geographic data for the European Union, its member countries, and
subnational regions. GISCO provides shapefiles in different formats, focusing
especially on the EU but also offering worldwide datasets such as country
...
that subsequent requests for the same data are served from the local cache.
