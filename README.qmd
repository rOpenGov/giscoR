...
[GISCO](https://ec.europa.eu/eurostat/web/gisco) database. It lets you download
and work with global and European geospatial datasets directly in **R**,
including country boundaries, NUTS regions, coastal lines and labels.

## Key features

- Retrieve GISCO datasets for countries, regions, administrative units and
  statistical units.
