...
provides a simple interface to Eurostat's [GISCO geodata
...
country boundaries, NUTS regions, administrative units and statistical units.
...
are obtained with the **eurostat** package, following the work of [Milos
